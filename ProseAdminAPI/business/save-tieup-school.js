...
module.exports = require('express').Router().post('/',async(req,res) =>
{
    try
    {
        ...
        {
            if(reqData.name != "" && reqData.email != "" && reqData.mobile != "" && reqData.website != "" && reqData.contactPerson != "" && reqData.address != "" && reqData.country.id != "" && reqData.stateRegion.id != "" && reqData.district.id != "" && reqData.city.id != "" && reqData.pincode != "" && reqData.syllabus.id != "" && reqData.panNumber != "" && reqData.contractFrom != "" && reqData.contractTo != "")
            {
                name = reqData.name;
                email = reqData.email;
