(function () {
  ...
  a.AmSlicedChart = a.Class({
    ...
    formatString: function (f, e, h) {
      ...
      f = a.massReplace(f, { '[[title]]': e.title, '[[description]]': e.description });
      this.pf.precision = g;
    ...
    rollOverSlice: function (i, e, n) {
      ...
      if (!i.hidden) {
        ...
        this.fire({ type: 'rollOverSlice', dataItem: i, chart: this, event: n });
      }
    },
    ...
    clickSlice: function (e, d, f) {
      this.checkTouchDuration(d) &&
        ...
        f || this.fire({ type: 'clickSlice', dataItem: e, chart: this, event: d }));
    },
    handleRightClick: function (d, c) {
      isNaN(d) || (d = this.chartData[d]);
      this.fire({ type: 'rightClickSlice', dataItem: d, chart: this, event: c });
    },
    drawTicks: function () {
      var f = this.chartData,
        e;
