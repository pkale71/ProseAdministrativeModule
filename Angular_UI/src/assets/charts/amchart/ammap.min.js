    ...
    if (1 < t) {
      for (j = s.length - 1; -1 < j; j--) {
        if (
          ...
          1 > d && (d = 1),
          (r = a.roundTo(i, d)),
          (d = a.formatNumber(r, { precision: -1, decimalSeparator: q.decimalSeparator, thousandsSeparator: q.thousandsSeparator })),
          !p || i == r)
        ) {
          o = n + '' + d + '' + s[j].prefix;
          break;
...
(function () {
  ...
  a.AmDraw = a.Class({
    ...
    rect: function (i, d, p, o, n, m, l) {
      ...
      1 > p && (p = 1);
      1 > o && (o = 1);
      j.attr({ x: i, y: d, width: p, height: o, rx: n, ry: n, 'stroke-width': m });
...
(function () {
  ...
  a.SVGRenderer = a.Class({
    ...
    animate: function (h, d, l, k, j) {
      ...
      l = { obj: h, frame: 0, attribute: d, from: i, to: l, time: k, effect: j };
...
(function () {
  ...
  a.AmChart = a.Class({
    ...
    addLabel: function (t, s, r, p, q, o, n, j, i, f) {
      t = { x: t, y: s, text: r, align: p, size: q, color: o, alpha: j, rotation: n, bold: i, url: f, enabled: !0 };
    ...
    animate: function (i, d, n, m, l, k, j) {
      ...
      n = { obj: i, frame: 0, attribute: d, from: n, to: m, time: l, effect: k, suffix: j };
      i['an_' + d] = n;
      ...
      if (!isNaN(al)) {
        ...
        if (this.show) {
          ...
          this.drop
            ...
            : 0 < N || 0 === X
            ? (0 < O && ((al = a.rect(ah, j, P, aa, 0, Y + 1, U, O, N)), a.isModern ? al.translate(1, 1) : al.translate(4, 4), ag.push(al)),
            ...
            : ((W = []),
              ...
              'H' != R
                ...
                : ((R = ak - Z),
                  ...
                  (W =
                    al < af + (ad - af) / 2 ? [0, 0, I < al ? 0 : al - I, 0, 0, j, j, 0] : [j, j, I + j > al ? j : al - I, j, j, 0, 0, j])),
...
(function () {
  ...
  a.circle = function (r, q, p, o, n, m, j, i, d) {
    ...
    void 0 === m && (m = '#000000');
    void 0 === j && (j = 0);
    o = { fill: p, stroke: m, 'fill-opacity': o, 'stroke-width': n, 'stroke-opacity': j };
  ...
  a.polygon = function (A, z, y, x, w, v, u, s, q, o, j) {
    ...
    void 0 === u && (u = i);
    w = { fill: i, stroke: u, 'fill-opacity': w, 'stroke-width': v, 'stroke-opacity': s };
  ...
  a.triangle = function (r, q, p, n, o, m, j, i) {
    ...
    void 0 === j && (j = '#000');
    void 0 === i && (i = 0);
    n = { fill: n, stroke: j, 'fill-opacity': o, 'stroke-width': m, 'stroke-opacity': i };
    q /= 2;
    var f;
  ...
  a.drop = function (G, F, D, A, C, z, x, w) {
    ...
    90 == D && (E = 0);
    270 == D && ((E = 0), (j = -j));
    D = { fill: A, stroke: x, 'stroke-width': z, 'stroke-opacity': w, 'fill-opacity': C };
    F =
      'M' +
      s +
      ',' +
  ...
  a.wedge = function (al, ak, aj, ai, ah, ag, af, ae, ad, ac, ab, aa, T, W) {
    ...
    var N = (1 / 180) * Math.PI,
      ...
      S = { fill: a.adjustLuminosity(ac.fill, -0.2), 'stroke-opacity': 0, 'fill-opacity': ac['fill-opacity'] },
      M = 0;
    180 < Math.abs(ah) && (M = 1);
    ai = al.set();
    var O;
  ...
  a.AmMap = a.Class({
      ...
      if (a.isModern) {
        ...
        if (!f.preventHover) {
          ...
          isNaN(h) ||
            ...
            ((f.mapWasDragged = !0),
            (d = { type: 'dragCompleted', zoomX: f.zoomX(), zoomY: f.zoomY(), zoomLevel: f.zoomLevel(), chart: f }),
            f.fire(d));
    ...
    rollOverMapObject: function (g, e, j) {
      if (this.chartCreated) {
        ...
        if (!this.preventHover) {
          ...
          this.fire({ type: 'rollOverMapObject', mapObject: g, chart: this, event: j });
    ...
    rollOutMapObject: function (d, c) {
      ...
      d &&
        ...
        this.fire({ type: 'rollOutMapObject', mapObject: d, chart: this, event: c }));
    },
    formatString: function (i, d) {
      ...
      var j = d.customData;
      void 0 == j && (j = '');
      return (i = a.massReplace(i, { '[[title]]': l, '[[value]]': k, '[[percent]]': n, '[[description]]': m, '[[customData]]': j }));
    },
    mouseDownMapObject: function (d, c) {
      this.fire({ type: 'mouseDownMapObject', mapObject: d, chart: this, event: c });
    },
    ...
    positionChanged: function () {
      var b = { type: 'positionChanged', zoomX: this.zoomX(), zoomY: this.zoomY(), zoomLevel: this.zoomLevel(), chart: this };
      this.fire(b);
    },
    getX: function (d, c) {
      ...
      if (aw.remainVisible || au.selectedObject == aw.parentObject) {
        ...
        if (0 < af.length) {
          ...
          if (isNaN(aj)) {
            ...
            ag = 1;
            0 > ae && (ag = 0);
            Z = { fill: 'none', stroke: an, 'stroke-opacity': 1, 'stroke-width': V / al, 'fill-opacity': 0, 'stroke-linecap': 'round' };
            ...
            an = ad.path(ao).attr({ 'fill-opacity': 0, stroke: an, 'stroke-width': 5 / al, 'stroke-opacity': 0.001, fill: 'none' });
          }
    ...
    init: function (x, w) {
      if (this.enabled) {
        ...
        var r = 0,
          ...
          j = x.fontFamily,
          i = this.color,
          d = { precision: x.precision, decimalSeparator: x.decimalSeparator, thousandsSeparator: x.thousandsSeparator };
