...
export class CardComponent implements OnInit {
  ...
  cardRemove: string;
  userTypeCode: string;
  yearCalenderGenerated: boolean = true;
  yearCalenderClicked: boolean = false;

  // constructor
  constructor(config: NgbDropdownConfig, private commonSharedService : CommonSharedService) {
    ...
    this.commonSharedService.yearCalenderCardComponentObject.next({
      object : this,
      result : "success"
    });
  }
  ...
  {
    this.componentObject.generateYearCalender();
  }
