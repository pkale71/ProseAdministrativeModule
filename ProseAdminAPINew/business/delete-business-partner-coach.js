...
module.exports = require('express').Router().post('/',async(req,res) =>
{
    try
    {
        ...
        {
            if(reqData.businessPartner.uuid != "")
            {
                id = reqData.id;
                ...
                {                                      
                    ...
                    let deleteBusinessPartnerCoachResult = await dbBusiness.deleteBusinessPartnerCoach(id, businessPartner[0].id);
        ///////
                    if(deleteBusinessPartnerCoachResult.affectedRows > 0)
                    {
                        res.status(200)
                        return res.json({
                            "status_code" : 200,
                    ...
                    else
                    {
                        ...
                        return res.json({
                            "status_code" : 500,
                            "message" : "Business Partner Coach Already Deleted",
                            "success" : false,
