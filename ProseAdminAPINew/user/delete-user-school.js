...
module.exports = require('express').Router().post('/',async(req,res) =>
{
    try
    {
        ...
        if(reqData.user != undefined && reqData.school != undefined && reqData.module != undefined)
        {
            if(reqData.user.uuid != "" && reqData.school.uuid != "" && moduleId != "")
            {
            ...
            ///Check School
                ...
                let deleteUserSchoolResult = await dbUser.deleteUserSchool(deleteJSON);
    ///////
